...
import servicePrincipalRouter from './routes/servicePrincipals';
...
app.use('/api/service-principals', servicePrincipalRouter);
app.use('/api/internal/v1/hardware', internalHardwareRouter);
