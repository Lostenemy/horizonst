...
main() {
  ...
  log INFO \
    "Configuration: BACKUP_ROOT=$BACKUP_ROOT PG_DIR=$PG_DIR LOG_DIR=$LOG_DIR" \
    "RETENTION_DAYS=$RETENTION_DAYS MIN_FREE_PERCENT=$MIN_FREE_PERCENT" \
    "POSTGRES_CONTAINER=$POSTGRES_CONTAINER POSTGRES_USER=$POSTGRES_USER."
